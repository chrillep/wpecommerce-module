...
// Setup
$nzshpcrt_gateways[$num]['name'] = 'SVEA Direktbank';
$nzshpcrt_gateways[$num]['internalname'] = 'svea_dbank_gateway';
$nzshpcrt_gateways[$num]['function'] = 'gateway_svea_dbank_gateway';
$nzshpcrt_gateways[$num]['form'] = "form_svea_dbank_gateway";
$nzshpcrt_gateways[$num]['submit_function'] = "submit_svea_dbank_gateway";

//Form to be shown when "SVEA faktura" option is chosen in checkoutpage
$gateway_checkout_form_fields[$nzshpcrt_gateways[$num]['internalname']] .= '';


function form_svea_dbank_gateway(){
	...
	$output .='<tr>';
	$output.='<td><img src="' . get_option('siteurl') . '/wp-content/plugins/wp-e-commerce/wpsc-merchants/svea_dbank.png" title="SVEA Direktbank" /></td>';
	$output.='<td></td>';
	$output.= '</tr><tr>';
...
function submit_svea_dbank_gateway(){
	...
	$payment_gateway_names["svea_dbank_gateway"] = 'SVEA Direktbank <img src="' . get_option('siteurl') . '/wp-content/plugins/wp-e-commerce/wpsc-merchants/svea_dbank.png" title="SVEA Direktbank" />';
...
function gateway_svea_dbank_gateway($seperator, $sessionid){
...
foreach($wpsc_cart->cart_items as $i => $Item) {
    ...
    //$orderRow->description = "Testprodukt";
...
class wpsc_merchant_svea_dbank extends wpsc_merchant {
...
add_action('wp_enqueue_scripts',  array('wpsc_merchant_svea_dbank','svea_scripts'));
add_action('wpsc_bottom_of_shopping_cart',  array('wpsc_merchant_svea_dbank','visa_form'));
?>